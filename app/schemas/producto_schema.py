...
class ProductoSchema(Schema):
    ...
    productoDescripcion = fields.String(
        required=True, validate=campo_necesario)
...
product_schema = ProductoSchema()  # SOLO 1
products_schema = ProductoSchema(many=True)  # PARA VARIOS
